...
\begin{enumerate}
  ...
  \item \textbf{Controlled schema evolution scenarios.} A family of controlled
  tabular datasets is prepared from the real-world NYC yellow taxi data. Three
  schema versions (V1--V3) are constructed with documented changes (column
